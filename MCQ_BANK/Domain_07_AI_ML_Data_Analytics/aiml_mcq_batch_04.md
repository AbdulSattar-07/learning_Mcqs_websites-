# AI/ML/Data Analytics MCQ Bank - Batch 04
...
A) Computer speed
B) Machine's ability to exhibit intelligent behavior
C) Memory capacity
D) Processing power

✔ Correct Answer: B
Reason: Turing Test assesses if a machine can exhibit human-like intelligence in conversation.
Tag: Past Paper
...
✔ Correct Answer: B
Reason: Squares of even numbers in range(5): 0²=0, 2²=4, 4²=16.
Tag: Normal
...
Subtopic: Kernel Methods
Difficulty: Hard

Question: What is the kernel trick advantage?
A) Faster computation
B) Implicit mapping to high dimensions without computing coordinates
C) Smaller models
D) Better visualization

✔ Correct Answer: B
Reason: Kernel trick computes inner products in high-dimensional space efficiently.
Tag: Normal
...
A) Energy
B) Uncertainty or information content
C) Temperature
D) Speed

✔ Correct Answer: B
Reason: Entropy quantifies average information content or uncertainty in random variable.
Tag: Normal
...
✔ Correct Answer: B
Reason: Weight decay adds penalty proportional to squared weights (L2 regularization).
Tag: Normal
...
Subtopic: Data Annotation
Difficulty: Easy

Question: What is data annotation?
A) Data storage
B) Labeling data for supervised learning
C) Data deletion
D) Data compression

✔ Correct Answer: B
Reason: Annotation involves adding labels/tags to data for training supervised models.
Tag: Normal
...
Subtopic: Contextualized Embeddings
Difficulty: Hard

Question: How do contextualized embeddings differ from static embeddings?
A) No difference
B) Contextualized embeddings vary based on context
C) Static are better
D) Contextualized are faster

✔ Correct Answer: B
Reason: Contextualized embeddings (like BERT) generate different vectors based on surrounding words.
Tag: Normal
...
Question: What is the EM algorithm used for?
A) Classification
B) Finding maximum likelihood estimates with latent variables
C) Regression
D) Feature selection

✔ Correct Answer: B
Reason: EM iteratively estimates parameters when data has missing/latent variables.
Tag: Normal
...
✔ Correct Answer: B
Reason: Bootstrap creates samples by randomly selecting with replacement from original data.
Tag: Normal
...
Question: What is image normalization?
A) Resizing images
B) Scaling pixel values to standard range
C) Rotating images
D) Cropping images

✔ Correct Answer: B
Reason: Normalization scales pixel values (e.g., to [0,1] or mean=0, std=1).
Tag: Normal
...
✔ Correct Answer: B
Reason: OOB error estimates generalization using samples left out during bagging.
Tag: Normal
...
✔ Correct Answer: B
Reason: Transpose swaps dimensions: original (3,2) becomes (2,3).
Tag: Normal
...
Subtopic: Missing Data Patterns
Difficulty: Medium
...
Domain: AI/ML/Data Analytics
Topic: Computer Vision
Subtopic: Region Proposal Networks
Difficulty: Hard
...
Domain: AI/ML/Data Analytics
Topic: Supervised Learning
Subtopic: Learning Curves Analysis
Difficulty: Medium
...
Domain: AI/ML/Data Analytics
Topic: Model Evaluation & Validation
Subtopic: Nested Cross-Validation
Difficulty: Hard
...
Domain: AI/ML/Data Analytics
Topic: Supervised Learning
Subtopic: Probabilistic Classifiers
Difficulty: Medium
...
Domain: AI/ML/Data Analytics
Topic: Supervised Learning
Subtopic: Cost-Sensitive Learning
Difficulty: Hard
...
Domain: AI/ML/Data Analytics
Topic: Supervised Learning
Subtopic: Prototype-Based Learning
Difficulty: Hard
...
Domain: AI/ML/Data Analytics
Topic: Exploratory Data Analysis (EDA)
Subtopic: Outlier Detection Methods
Difficulty: Medium
...
Domain: AI/ML/Data Analytics
Topic: Supervised Learning
Subtopic: Ordinal Classification
Difficulty: Hard
...
Domain: AI/ML/Data Analytics
Topic: Computer Vision
Subtopic: Point Cloud Processing
Difficulty: Hard

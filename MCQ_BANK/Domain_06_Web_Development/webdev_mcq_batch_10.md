# Web Development MCQ Bank - Batch 10
...
Question: What is the syntax for dynamic imports in JavaScript?
A) require('module')
B) import('module')
C) load('module')
D) fetch('module')
...
✔ Correct Answer: B
Reason: import() returns a promise and loads modules dynamically at runtime.
Tag: Normal
...
A) Highlights text
B) Sets color for form controls like checkboxes
C) Background accent
D) Border color

✔ Correct Answer: B
Reason: accent-color customizes the theme color of form controls.
Tag: Normal
...
Question: Why is dependency scanning important?
A) Faster builds
B) Identifying vulnerabilities in third-party packages
C) Reducing bundle size
D) Better performance

✔ Correct Answer: B
Reason: Dependency scanning detects known security vulnerabilities in dependencies.
Tag: Normal
...
Subtopic: Output Element
Difficulty: Medium

Question: What is the <output> element used for?
A) Console output
B) Displaying calculation or user action results
C) Error messages
D) Logging

✔ Correct Answer: B
Reason: <output> represents the result of a calculation or user action.
Tag: Normal
...
Subtopic: FinalizationRegistry
Difficulty: Hard

Question: What is FinalizationRegistry used for?
A) Final variables
B) Cleanup callbacks when objects are garbage collected
C) Finalizing functions
D) Registry pattern

✔ Correct Answer: B
Reason: FinalizationRegistry allows registering cleanup callbacks for garbage collection.
Tag: Normal
...
A) Data storage
B) Isolating resources to prevent cascading failures
C) Load balancing
D) Caching strategy

✔ Correct Answer: B
Reason: Bulkhead pattern partitions resources to contain failures to specific areas.
Tag: Normal
...
Subtopic: File System Access API
Difficulty: Medium
...
✔ Correct Answer: B
Reason: File System Access API allows web apps to interact with local file system.
Tag: Normal
...
Domain: Web Development
Topic: CSS Fundamentals
Subtopic: Color Functions
Difficulty: Medium

Question: What does the color-mix() function do?
A) Mixes paint
B) Blends two colors in specified color space
C) Generates random colors
D) Converts color formats

✔ Correct Answer: B
Reason: color-mix() creates new colors by mixing two colors with specified proportions.
Tag: Normal
...
Subtopic: Polyrepo vs Monorepo
Difficulty: Medium

Question: What is a polyrepo approach?
A) Multiple repositories for different projects
B) Single repository
C) No repositories
D) Polymer framework

✔ Correct Answer: A
Reason: Polyrepo uses separate repositories for each project/service.
Tag: Normal
...
✔ Correct Answer: B
Reason: Sidecar pattern deploys auxiliary services alongside main application container.
Tag: Normal
...
Subtopic: Lazy Loading Components
Difficulty: Medium

Question: What is code splitting at the component level called?
A) Component division
B) Lazy loading / Dynamic imports
C) Component caching
D) Component bundling

✔ Correct Answer: B
Reason: Lazy loading defers component loading until needed, reducing initial bundle.
Tag: Normal
...
✔ Correct Answer: B
Reason: AbortController provides signal to cancel fetch requests and other async operations.
Tag: Normal
...
✔ Correct Answer: B
Reason: Migrations track and apply incremental database schema changes.
Tag: Normal
...
Subtopic: Largest Contentful Paint
Difficulty: Medium
...
Domain: Web Development
Topic: Web Performance & Optimization
Subtopic: Interaction to Next Paint
Difficulty: Medium
...
Domain: Web Development
Topic: Modern Web Development Practices
Subtopic: Gitflow vs Trunk-Based
Difficulty: Medium
...
Domain: Web Development
Topic: Server-Side Programming
Subtopic: Backends for Frontends
Difficulty: Hard
...
Domain: Web Development
Topic: Modern Web Development Practices
Subtopic: Feature Toggles vs Feature Flags
Difficulty: Easy
...
Domain: Web Development
Topic: Databases for Web Applications
Subtopic: Eventual vs Causal Consistency
Difficulty: Hard
